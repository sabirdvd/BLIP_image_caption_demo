...
For image captioning only with the **Larger model** with the two proposed caption generation method (beam search and nucleus sampling), that runs on your local machine with multiple images 
```
